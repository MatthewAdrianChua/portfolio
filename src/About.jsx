            ...
            <div id="aboutMainContainer">
                <div id="profileAndContact">
                    ...
                    <div className="contactContainer">
                        ...
                        <h5 className="contactInfo" id="phone">+63 09173025353</h5>
                    </div>
                    <div className="contactContainer">
                ...
                <div id="credentialContainer">
                    ...
                    <div className="credentials" id="skills">
                        ...
                        <p>
                            ...
                            <p>Database Systems Knowledge: MySQL, MongoDB </p>
                            <p>Frameworks: ReactJS </p>
                            <p>- Leadership and Communication Skills </p>
                            <p>- Adaptability </p>
                            <p>- Knowledge of AI systems and Development </p>
                            <p>- Agile and DevOps development</p>
                    </div>
